...
fetch(`http://localhost:8081/api/movies/detail/${imdbId}`)
  ...
  .then(movie => {
    ...
    const actorHtml = movie.actors.map(actor => `<a href="actor.html?name=${actor}">${actor}</a>`).join(", ");
    // Tạo HTML chi tiết
    const detailHtml = `
      <div class="main">
        <div class="img">
        ...
        <div class="content">
          ...
          <div class="detail-actions">
            ...
            <div class="actors">${actorHtml}</div>
            <div class="btn">
    ...
    watchBtn?.addEventListener("click", () => {
      ...
      frameSection.innerHTML = `
        ...
        <div id="review-section" style="margin-top: 40px; background-color: #111; padding: 20px; border-radius: 10px; color: white;">
          ...
          <textarea id="review-input" rows="5" style="width: 100%; border-radius: 5px; padding: -8px;"></textarea>
